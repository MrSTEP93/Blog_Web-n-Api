...
namespace FinalBlog.Migrations
{
    ...
    [Migration("20241120210138_ChangeRole-to_ListRoles")]
    partial class ChangeRoleto_ListRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalBlog.DATA.Models.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalBlog.DATA.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArticleTag", b =>
                {
                    b.HasOne("FinalBlog.DATA.Models.Article", null)
                        .WithMany()
                        .HasForeignKey("ArticlesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinalBlog.DATA.Models.Tag", null)
                        .WithMany()
